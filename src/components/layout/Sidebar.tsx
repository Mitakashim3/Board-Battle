...
const navItems = [
  ...
  { icon: BookOpen, label: 'Solo Review', href: '/reviewer' },
  { icon: Swords, label: 'Battle Arena', href: '/battle' },
  ...
  return (
    <>
      <ConfirmModal
        ...
        title="Sign Out"
        description="Are you sure you want to sign out? You'll need to log in again to continue your review."
      ...
      >
        ...
        <div className="p-4 border-b border-white/5 h-[72px] flex items-center">
          <Link href="/dashboard" className="flex items-center gap-3 overflow-hidden">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1a4a7c] to-[#0d2847] flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-3 border-t border-white/5">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#1a4a7c] to-[#0d2847] flex items-center justify-center text-xs font-bold flex-shrink-0">
